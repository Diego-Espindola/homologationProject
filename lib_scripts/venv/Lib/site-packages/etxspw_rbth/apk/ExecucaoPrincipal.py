...
from Gerenciador_erros import checar_discrepancias_matricula, checar_discrepancias_evento, checar_discrepancias_endereco, checar_discrepancias_cargo, checar_discrepancias_dependentes
...
class ExecucaoPrincipal:
    ...
    def __init__(self, app, inicializar_erros):
        ...
        self.diretorio_geral = self.subir_diretorios(6, dirname(__file__))
